  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10 pb-16">
      ...
      >
        ...
        <Link to="/dashboard/upload" className="w-full md:w-auto mt-4 md:mt-0">
          <button className="w-full group relative inline-flex items-center justify-center gap-2 bg-[#1db954] text-black font-bold py-3.5 px-8 rounded-full overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(29,185,84,0.3)] hover:shadow-[0_0_30px_rgba(29,185,84,0.5)]">
      ...
      {distributions.length > 0 && (
        ...
        >
          <div className="p-6 md:p-8 border-b border-white/5 flex flex-col sm:flex-row items-start sm:items-center justify-between bg-black/20 gap-4">
            <div>
            ...
            <Link to="/dashboard/analytics" className="inline-flex w-full sm:w-auto justify-center items-center gap-2 text-sm text-zinc-400 hover:text-white transition-colors font-bold bg-white/5 hover:bg-white/10 px-5 py-2.5 rounded-full border border-white/5">
            ...
            <table className="w-full text-left border-collapse min-w-[500px]">
              <thead>
                <tr className="text-xs uppercase tracking-widest text-zinc-600 bg-black/40">
                  <th className="p-4 md:p-6 font-bold">Lançamento</th>
                  <th className="hidden md:table-cell p-6 font-bold">Data de Envio</th>
                  <th className="p-4 md:p-6 font-bold">Status</th>
                  <th className="p-4 md:p-6 font-bold text-right">Ação</th>
                </tr>
              </thead>
                      ...
                      >
                        <td className="p-4 md:p-6">
                          <div className="flex items-center gap-4 md:gap-5">
                            <div className="relative w-12 h-12 md:w-14 md:h-14 rounded-xl overflow-hidden shadow-lg group-hover:shadow-xl transition-all group-hover:scale-105 border border-white/5 shrink-0">
                              <img 
                            ...
                            <div className="min-w-0">
                              <p className="font-bold text-white text-base md:text-lg leading-tight mb-1 group-hover:text-[#1db954] transition-colors truncate">{song.title}</p>
                              <p className="text-xs md:text-sm text-zinc-500 font-medium truncate">{song.artist_name}</p>
                            </div>
                          </div>
                        </td>
                        <td className="hidden md:table-cell p-6 text-sm text-zinc-400 font-medium">
                          {uploadDate}
                        </td>
                        <td className="p-4 md:p-6">
                          <div className={`inline-flex items-center gap-1.5 md:gap-2 px-2 md:px-3 py-1 md:py-1.5 rounded-full border text-[10px] md:text-xs font-bold uppercase tracking-wider shadow-sm ${statusBadge}`}>
                            <StatusIcon size={12} className="md:w-3.5 md:h-3.5" />
                            <span className="truncate max-w-[80px] md:max-w-none">{statusText}</span>
                          </div>
                        </td>
                        <td className="p-4 md:p-6 text-right">
                          <button 
                            className="text-xs md:text-sm font-bold text-zinc-400 hover:text-white transition-colors px-3 md:px-5 py-2 md:py-2.5 rounded-full border border-white/5 hover:border-white/20 hover:bg-white/5 bg-black/20 whitespace-nowrap"
                          >
