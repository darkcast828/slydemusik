      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-5xl md:text-6xl font-black text-white tracking-tighter">$450.20</h2>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter">$124.50</h2>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-white/10 text-zinc-400 text-sm uppercase tracking-wider">
                  <th className="pb-4 font-bold px-4">Música</th>
                  <th className="pb-4 font-bold text-right px-4">Streams Totais</th>
                  <th className="pb-4 font-bold text-right px-4">Receita Gerada</th>
                </tr>
              </thead>
                    ...
                    >
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 bg-black/40 rounded-xl flex items-center justify-center overflow-hidden shadow-md border border-white/5 group-hover:border-white/10 transition-colors">
                            {song.cover ? (
                          ...
                          <span className="text-white font-bold text-base">{song.title}</span>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4 text-right font-black text-lg text-[#1db954]">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/10 text-zinc-400 text-sm uppercase tracking-wider">
                ...
                <th className="pb-4 font-bold px-4">Plataforma</th>
                <th className="pb-4 font-bold text-right px-4">Valor</th>
                <th className="pb-4 font-bold text-right px-4">Status</th>
              </tr>
            </thead>
            <tbody className="text-sm">
              {[
                { date: '01 Nov 2023', desc: 'Royalties Outubro', plat: 'Spotify', amount: '+$84.20', status: 'Concluído', color: 'text-[#1db954]' },
                { date: '28 Out 2023', desc: 'Saque PayPal', plat: '-', amount: '-$200.00', status: 'Processado', color: 'text-white' },
                { date: '01 Out 2023', desc: 'Royalties Setembro', plat: 'Apple Music', amount: '+$45.30', status: 'Concluído', color: 'text-[#1db954]' },
                { date: '01 Set 2023', desc: 'Royalties Agosto', plat: 'Múltiplas', amount: '+$112.50', status: 'Concluído', color: 'text-[#1db954]' },
              ].map((tx, i) => (
                <motion.tr 
                  key={i} 
                  initial={{ opacity: 0, y: 10 }}
                ...
                >
                  <td className="py-4 px-4 text-zinc-400 font-medium">{tx.date}</td>
                  <td className="py-4 px-4 text-white font-bold">{tx.desc}</td>
                  <td className="py-4 px-4 text-zinc-400 font-medium">{tx.plat}</td>
                  <td className={`py-4 px-4 text-right font-black text-lg ${tx.color}`}>{tx.amount}</td>
